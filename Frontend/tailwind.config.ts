  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "navy-border-2": "var(--color-border-2)",
        "navy-accent": "var(--color-accent)",
        "navy-accent-lt": "var(--color-accent-lt)",
        "navy-success": "var(--color-success)",
        "navy-warning": "var(--color-warning)",
        "navy-error": "var(--color-error)",
        "navy-text": "var(--color-text)",
        "navy-text-2": "var(--color-text-2)",
        "navy-text-3": "var(--color-text-3)",
      ...
      boxShadow: {
        ...
        "nba": "0 0 0 3px hsl(var(--primary) / 0.15), 0 8px 24px -4px hsl(var(--primary) / 0.2)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      animation: {
        ...
        "nba-pulse": "nba-pulse 2.5s ease-in-out infinite",
