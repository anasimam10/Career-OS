...
export const MOCK_COACH_RESPONSES: Record<string, CoachResponse> = {
  default: {
    ...
    next_best_action: "Explore verified BS Computer Science programs in your target city.",
    next_best_action_type: "EXPLORE",
    reasoning_summary: "Foundational exploration is best suited for your current stage.",
    quick_actions: [
    ...
    sources: [
      { title: "HEC Recognised Universities", source_url: "https://www.hec.gov.pk/english/universities/pages/recognised.aspx" }
    ],
  },
  next_step: {
    message:
      "Your next step is clear: start with Python basics. It's the single most valuable skill you can build right now, and it unlocks everything else — data science, web development, automation. Spend 3–4 hours this week on the official Python tutorial.",
    next_best_action: "Complete the first 3 modules of Python Basics on DigiSkills or official docs.",
    next_best_action_type: "LEARN",
    reasoning_summary: "Python provides immediate practical leverage for Pakistani tech careers.",
    quick_actions: [
    ...
    suggested_resource: null,
    sources: [
      { title: "DigiSkills Free Courses", source_url: "https://digiskills.pk" }
    ],
  },
  internship: {
    message:
    ...
    next_best_action: "Build a single-page project and upload it to GitHub before applying.",
    next_best_action_type: "PRACTICE",
    reasoning_summary: "Employers look for demonstrable code repositories in internship applicants.",
    quick_actions: [
