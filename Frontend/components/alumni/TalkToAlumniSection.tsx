...
export function TalkToAlumniSection() {
  ...
  return (
    <>
      {/* Entry Card */}
      <div className="relative overflow-hidden rounded-3xl border border-slate-800 bg-slate-900/50 p-6 sm:p-8 backdrop-blur-sm transition-all hover:border-indigo-500/40 hover:shadow-2xl hover:shadow-indigo-950/30">
        {/* Subtle decorative glow */}
        <div className="absolute -right-16 -top-16 h-64 w-64 rounded-full bg-indigo-500/10 blur-3xl pointer-events-none" />
        <div className="absolute -left-16 -bottom-16 h-64 w-64 rounded-full bg-indigo-500/5 blur-3xl pointer-events-none" />
          ...
          <div className="relative w-full max-w-2xl overflow-hidden rounded-3xl border border-slate-800 bg-[#0B0F17] p-6 sm:p-8 shadow-2xl space-y-6">
            ...
            <div className="rounded-2xl border border-indigo-500/20 bg-indigo-950/30 p-4 sm:p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="space-y-1 text-center sm:text-left">
                <div className="text-sm font-bold text-white">Ready to connect with an alumnus?</div>
                <p className="text-xs text-indigo-200/80">
                  Connect with verified graduates from NUST, FAST, LUMS, IBA, and GIKI across your target field.
                </p>
              </div>
